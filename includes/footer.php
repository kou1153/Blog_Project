...
<footer class="bg-dark text-center text-white mt-5">
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
        ©Copyright: Don't mind if i steal.
    </div>
    <!-- Copyright -->
</footer>
<!-- Footer -->
...
<!-- Jquery JS-->
<script src="./signupStyle/vendor/jquery/jquery.min.js"></script>
<!-- Vendor JS-->
<script src="./signupStyle/vendor/select2/select2.min.js"></script>
<script src="./signupStyle/vendor/datepicker/moment.min.js"></script>
<script src="./signupStyle/vendor/datepicker/daterangepicker.js"></script>

<!-- Main JS-->
<script src="./signupStyle/js/global.js"></script>
